...
// error  Unexpected console statement  no-console
  ...
  const xScale = d3.scaleBand()
    ...
    .range([0, width])
    .padding(0.1);
// KL: do not hard code xScale domain, use d.cat

  const yScale = d3.scaleLinear()
    .domain([10, 0])
    .range([0, height]);
// KL: -5
// yScale domain should be [0, max(data)]
...
// KL: -1
// Do not fill your own color, use default
...
// KL: Do not use bindNewSvg, use newSvg
  ellipseSvg('ellipse')
  .selectAll('.ellipse')
  .data(data)
...
// KL: you can dry out the final three tasks by combining summarizing their
// modifications as a list of objects
...
// KL: -5
// Scale for luminace should be somewhere between 20 and 80
